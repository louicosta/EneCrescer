...
const updateCartoonById = async (req, res) => {
  try {
    ...
    findCartoon.originalBroadcaster =
      originalBroadcaster || findCartoon.originalBroadcaster;
    findCartoon.durationEpisode =
      durationEpisode || findCartoon.durationEpisode;
